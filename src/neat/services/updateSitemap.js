...
// 2. проходим по базе и добавляем новый узел, если нет в xml, маркируем найденные и добавленные, маркируем sitePages.js
...
export async function readXmlToJson() {
    try {
...
function saveSitemap() {
    ...
    let report = `sitemap обновлен, добавлено-${countAdded} удалено-${countDeleted}`
